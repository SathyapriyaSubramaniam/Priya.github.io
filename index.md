...
#### Determine the selling price of a house even when it is influenced by many factors like location, size, age etc,. Extensive Exploratory Data Analysis on this Kaggle dataset revealed some of the misinterpreted/low variance variables and aided in the process of Feature selection for model training
